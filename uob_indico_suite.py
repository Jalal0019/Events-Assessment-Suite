...
FONT_BUTTON  = ("Calibri", 11, "bold")
FONT_STATUS  = ("Calibri", 9)
FONT_TAB     = ("Calibri", 10, "bold")
...
# ============================================================
root = tk.Tk()
root.title("UoB Events Website Assessment Suite  |  حزمة تقييم موقع النشاطات العلمية")
root.geometry("1280x720")

# ---- App icon (University of Baghdad logo) ----
def _resource_path(relative_path):
    """Resolve a bundled asset path, whether running as a script or a PyInstaller exe."""
    base_path = getattr(sys, "_MEIPASS", os.path.dirname(os.path.abspath(__file__)))
    return os.path.join(base_path, relative_path)

try:
    icon_path = _resource_path(os.path.join("assets", "uob_logo.ico"))
    root.iconbitmap(icon_path)
except Exception:
    pass  # non-Windows platforms (e.g. Linux/Mac) don't support .ico via iconbitmap
...
tk.Label(footer, text="Systems & Applications Unit - University of Baghdad",
